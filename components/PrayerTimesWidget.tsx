    ...
    useEffect(() => {
        ...
        const fetchPrayerTimes = async () => {
            ...
            try {
                ...
                // Determine method based on country (Simplified logic)
                // 4 = Umm Al-Qura (Makkah)
                // 1 = University of Islamic Sciences, Karachi (Dhaka/South Asia)
                // 2 = ISNA (North America) - Default fallback
                let method = 2;
        ...
        <div className="fixed bottom-6 left-6 z-[100] flex flex-col items-start">
            ...
            >
                ...
                <div className="bg-[var(--color-primary)] p-3 text-center">
                    ...
                    <p className="text-white/80 text-xs">{new Date().toLocaleDateString('en-US', { weekday: 'long', day: 'numeric', month: 'long' })}</p>
                </div>
                ...
                <div className="p-4 min-h-[200px]">
                    {loading ? (
                         <div className="flex flex-col items-center justify-center h-40 space-y-2">
                            ...
                            <p className="text-xs text-[var(--color-muted-text)]">Loading times...</p>
                        </div>
                    ) : error ? (
                        <div className="flex flex-col items-center justify-center h-40 text-center">
                            <p className="text-red-400 text-sm mb-2">Unable to load prayer times.</p>
                 ...
                 <div className="p-2 bg-[var(--color-dark-bg)] text-center border-t border-gray-700">
                    <p className="text-[10px] text-[var(--color-muted-text)]">Times source: Aladhan API</p>
                </div>
            </div>
