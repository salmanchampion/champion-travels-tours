...
const ExpertHajjGuides: React.FC = () => {
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-20 text-gray-800">
        ...
        <section className="flex flex-col md:flex-row items-center gap-12 mb-24">
          <div className="md:w-1/2 text-center md:text-left">
            ...
            <CtaButton href="#contact?subject=Booking Inquiry: Hajj">{whyChooseUs.services.buttonText}</CtaButton>
          </div>
          <div className="md:w-1/2 flex justify-center">
        ...
        <section className="text-center py-16">
            ...
            <div className="mt-8">
                <CtaButton href="#contact?subject=Request for Hajj Booking Online">{whyChooseUs.cta.buttonText}</CtaButton>
            </div>
        </section>
      </div>
...
export default ExpertHajjGuides;