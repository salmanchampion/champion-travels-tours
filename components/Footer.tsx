...
const SocialIcon: React.FC<{ href: string; children: React.ReactNode }> = ({ href, children }) => (
  <a href={href} className="text-muted-text hover:text-primary transition-colors duration-300">
    {children}
  </a>
);
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#why-us" className="text-muted-text hover:text-primary transition-colors">Why Us</a></li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#services" className="text-muted-text hover:text-primary transition-colors">Air Ticketing</a></li>
            </ul>
          </div>
