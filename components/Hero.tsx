    ...
    <section className="relative h-screen w-full overflow-hidden text-white">
      ...
      <div className="relative z-20 container mx-auto px-4 h-full flex flex-col justify-center text-center">
          <div className="hero-slide-content">
              ...
              <p className="text-base md:text-lg font-sans text-[var(--color-primary)] mb-6">
              {hero.licenseInfo}
              </p>
              <h2 className="text-5xl md:text-6xl lg:text-7xl font-display font-extrabold text-[var(--color-light-text)] mb-6">
              {hero.subtitle}
              </h2>
              <p className="text-lg md:text-xl max-w-3xl mx-auto mb-8 text-[var(--color-light-text)]/90">
              {hero.description}
              </p>
              <a
              href="#packages"
      ...
      {hero.images.length > 1 && (
        ...
        <button 
            onClick={prevSlide}
            className="absolute top-1/2 left-4 -translate-y-1/2 z-30 p-2 bg-black/30 rounded-full hover:bg-black/50 transition-colors"
        ...
        <button 
            onClick={nextSlide}
            className="absolute top-1/2 right-4 -translate-y-1/2 z-30 p-2 bg-black/30 rounded-full hover:bg-black/50 transition-colors"
