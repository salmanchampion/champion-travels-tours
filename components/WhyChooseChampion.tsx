...
const FeatureCard: React.FC<{ section: WhyChooseSection }> = ({ section }) => (
  <div className="bg-[var(--color-light-bg)] p-8 rounded-[var(--ui-border-radius)] text-center transform hover:-translate-y-2 transition-transform duration-300 shadow-[var(--ui-shadow)] hover:shadow-[var(--color-primary)]/20">
        ...
        <section className="py-20 bg-[var(--color-dark-bg)]">
            <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                <div className="text-center mb-12">
                    <h2 className="text-4xl md:text-5xl font-display font-bold text-[var(--color-primary)]">{content.title}</h2>
                    <p className="mt-4 text-lg text-[var(--color-muted-text)] max-w-3xl mx-auto">{content.subtitle}</p>
                    <div className="mt-6">
                        <button 
