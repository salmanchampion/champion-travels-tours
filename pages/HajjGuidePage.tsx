...
const GuideSection: React.FC<{
    ...
    <section className="mb-16">
        <div className="text-center mb-10">
            <h2 className="text-3xl md:text-5xl font-display font-bold text-dark-bg">{title}</h2>
        ...
        <div className="pt-20 bg-[#FBF9F5]" style={{ backgroundImage: `url('https://www.toptal.com/designers/subtlepatterns/uploads/islamic-style.png')` }}>
            <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-16 text-gray-800">
                ...
                <section className="text-center py-10">
                    ...
                    <div className="mt-8">
                        <a href="#contact?subject=Request for Hajj Booking Online" className="inline-block bg-secondary text-dark-bg font-bold py-4 px-10 rounded-full text-lg hover:bg-amber-600 transition-all duration-300 shadow-md hover:shadow-lg">
                            {cta.buttonText}
                        </a>
                    </div>
                </section>
