...
export const customPagesData: CustomPage[] = [
    {
        ...
        bannerSubtitle: "Comfortable and affordable stays for your pilgrimage and travels.",
        contentBlocks: [
            {
                type: "html",
                content: `
<h3>Luxury & Economy Hotels in Makkah & Madinah</h3>
<p>We provide a wide range of hotel options to suit every budget and preference. Whether you are looking for a luxurious 5-star hotel with a Kaaba view or a budget-friendly economy hotel close to the Haram, we have you covered. Our strong network with hotel chains in Saudi Arabia ensures that you get the best rates and confirmed bookings.</p>
<h4>Why Book With Us?</h4>
<ul>
<li><strong>Proximity to Haram:</strong> Most of our partner hotels are within walking distance to the Holy Mosques.</li>
<li><strong>Competitive Rates:</strong> We offer exclusive discounts that are not available on other booking platforms.</li>
<li><strong>Variety of Options:</strong> From single rooms to family suites and shared accommodations.</li>
<li><strong>24/7 Support:</strong> Our team is available to assist you with check-in and any special requests during your stay.</li>
</ul>
<p>Contact us today to find the perfect accommodation for your spiritual journey.</p>
`
            },
            {
                type: "image",
                src: "https://i.postimg.cc/50rQG1f5/umrah-2.jpg",
                alt: "Hotel Room with Kaaba View"
            }
        ],
        seo: {
            title: "Hotel Booking | Champion Travels & Tours",
            description: "Book luxury and economy hotels in Makkah, Madinah, and worldwide. Best rates guaranteed.",
            keywords: "Makkah hotels, Madinah hotels, hotel booking Bangladesh, cheap hotels Makkah"
        },
        enabled: true
    },
    {
        id: "#ziyarat-tours",
        title: "Ziyarat Tours",
        bannerSubtitle: "Explore the historical and holy sites of Islam.",
        contentBlocks: [
            {
                type: "html",
                content: `
<h3>Guided Ziyarat in Makkah & Madinah</h3>
<p>Complete your spiritual journey by visiting the historical sites associated with the life of Prophet Muhammad (PBUH) and his companions. Our Ziyarat tours are conducted by knowledgeable guides who explain the significance of each location.</p>
<h4>Sites in Makkah:</h4>
<ul>
<li><strong>Jabal al-Nour (Cave of Hira):</strong> The place where the first revelation was received.</li>
<li><strong>Jabal Thawr (Cave of Thawr):</strong> Where the Prophet (PBUH) and Abu Bakr (RA) took refuge during migration.</li>
<li><strong>Mina, Arafat, & Muzdalifah:</strong> The significant sites of Hajj rites.</li>
<li><strong>Jannat al-Mu'alla:</strong> The cemetery where Khadija (RA) is buried.</li>
</ul>
<h4>Sites in Madinah:</h4>
<ul>
<li><strong>Masjid Quba:</strong> The first mosque built by the Prophet (PBUH).</li>
<li><strong>Masjid al-Qiblatayn:</strong> The mosque where the direction of prayer (Qibla) was changed.</li>
<li><strong>Jabal Uhud:</strong> The site of the Battle of Uhud and the graves of the martyrs.</li>
<li><strong>Jannat al-Baqi:</strong> The cemetery where many family members and companions of the Prophet are buried.</li>
</ul>
`
            },
            {
                type: "image",
                src: "https://i.postimg.cc/RZ8BGSpf/aj.webp",
                alt: "Masjid Quba"
            }
        ],
        seo: {
            title: "Ziyarat Tours | Champion Travels & Tours",
            description: "Guided Ziyarat tours in Makkah and Madinah. Visit historical Islamic sites with experienced guides.",
            keywords: "Ziyarat Makkah, Ziyarat Madinah, Islamic historical tours, religious tourism"
        },
        enabled: true
    },
    {
        ...
        bannerSubtitle: "Learn the correct rituals and prepare for your spiritual journey.",
        contentBlocks: [
            {
                type: "html",
                content: `
<h3>Pre-Departure Seminars & Workshops</h3>
<p>Champion Travels & Tours organizes regular training sessions for intending pilgrims to ensure they perform their Umrah correctly and confidently. Our training programs are led by renowned Islamic scholars.</p>
<h4>Training Curriculum:</h4>
<ul>
<li><strong>Fiqh of Umrah:</strong> Step-by-step explanation of Ihram, Tawaf, Sa'i, and Halq/Taqsir.</li>
<li><strong>Spiritual Preparation:</strong> The importance of Niyyah (intention), Tawbah (repentance), and mental readiness.</li>
<li><strong>Logistical Guidance:</strong> Tips on packing, health & safety, using technology, and navigating the holy cities.</li>
<li><strong>Q&A Sessions:</strong> Open floor for pilgrims to ask specific questions regarding their journey.</li>
</ul>
<p>We believe that a well-informed pilgrim can attain the maximum spiritual benefit from their journey. These sessions are free for all our booked clients.</p>
`
            },
            {
                type: "image",
                src: "https://i.postimg.cc/CL6k3832/ak.jpg",
                alt: "Pilgrims in Training"
            }
        ],
        seo: {
            title: "Umrah Training | Champion Travels & Tours",
            description: "Comprehensive Umrah training and seminars in Bangladesh. Learn Umrah rituals from experts.",
            keywords: "Umrah training, Umrah guide, Hajj seminar, learn Umrah"
        },
        enabled: true
    },
    {
        id: "#about-us",
        title: "About Us",
        bannerSubtitle: "Your Trusted Partner in Spiritual Journeys Since 2005",
        contentBlocks: [
            {
                type: "html",
                content: `
<h3>Who We Are</h3>
<p>Champion Travels & Tours is a premier travel agency based in Dhaka, Bangladesh, specializing in Hajj, Umrah, and international tour packages. Established in 2005, we have successfully served over 35,000 pilgrims, helping them fulfill their spiritual obligations with peace of mind and comfort.</p>
<p>Our mission is to provide high-quality, reliable, and transparent travel services. We are an IATA-accredited agency and a proud member of HAAB (Hajj Agencies Association of Bangladesh) and ATAB (Association of Travel Agents of Bangladesh). Our team comprises experienced travel consultants and religious scholars who are dedicated to guiding you at every step of your journey.</p>

<h3>Our Core Values</h3>
<ul>
    <li><strong>Integrity:</strong> We believe in honest and transparent dealings with no hidden costs.</li>
    <li><strong>Service Excellence:</strong> We strive to exceed our clients' expectations through personalized care.</li>
    <li><strong>Commitment:</strong> We are committed to ensuring your journey is smooth, safe, and spiritually rewarding.</li>
</ul>

<h3>Why Trust Us?</h3>
<p>With years of experience and a strong network of partners in Saudi Arabia and across the globe, we can offer exclusive deals on hotels and flights. Whether you are looking for a VIP Hajj package or a budget-friendly holiday tour, Champion Travels & Tours is your reliable companion.</p>
`
            },
            {
                type: "image",
                src: "https://i.postimg.cc/rwn0QTMc/image.png",
                alt: "Chairman of Champion Travels"
            }
        ],
        seo: {
            title: "About Us | Champion Travels & Tours",
            description: "Learn about Champion Travels & Tours, a leading Hajj and Umrah agency in Bangladesh with over 15 years of experience.",
            keywords: "About Champion Travels, travel agency profile, Hajj agency Bangladesh"
        },
        enabled: true
    },
    {
        ...
        bannerSubtitle: "We value your privacy and are committed to protecting your personal data.",
        contentBlocks: [
            {
                type: "html",
                content: `
<h3>Introduction</h3>
<p>At Champion Travels & Tours, we take your privacy seriously. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you visit our website or use our services. Please read this privacy policy carefully. If you do not agree with the terms of this privacy policy, please do not access the site.</p>
...
<ul>
    <li>Process your booking and visa applications.</li>
...
<strong>Email:</strong> championtravels.Dhaka@gmail.com<br>
<strong>Phone:</strong> +8801718425042</p>
`
            }
        ],
        seo: {
            title: "Privacy Policy | Champion Travels & Tours",
            description: "Read our privacy policy to understand how we handle your personal information and data.",
